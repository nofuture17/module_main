...
class MailController extends \yii\web\Controller
{
    public function actionCallBack()
    {
        ...
        if ($this->sendMail($model)) {
            $model->active = \app\modules\main\models\MainMail::ACTIVE_ACTIVE;
        } else {
            $model->active = \app\modules\main\models\MainMail::ACTIVE_BLOCKED;
        }
    ...
    /**
     * @return \app\modules\main\models\MainMail
     */
    protected function createModel()
    {
        ...
        $model = new \app\modules\main\models\MainMail();
...
//        }
    ...
    /**
     * @param $mail \app\modules\main\models\MainMail
     * @return mixed
     */
