...
use Yii;
use amd_php_dev\module_main\models\Tag;
use amd_php_dev\module_main\models\TagSearch;
 ...
 */
class TagController extends \amd_php_dev\yii2_components\controllers\AdminController
{
